      ...
      mutations.forEach(function(mutation) {
          ...
          if (mutation.type === "attributes" && mutation.attributeName === "class") {
              ...
              if (errorMessageContainer) {
                  // Find the .form-label within the same element
                  ...
                  if (label) {
                      ...
                      // Move the error message container next to the label regardless of the error message
                      ...
                      if (errorMessage) {
                          // Check if the error message text is "This field is required."
                          if (errorMessage.textContent === "This field is required.") {
                          ...
                          // Announce the error message using the aria-live region
