    ...
    mutations.forEach(function(mutation) {
      ...
      if (mutation.type === "attributes" && mutation.attributeName === "class") {
        ...
        if (errorMessageContainer) {
          // Check if the error message does not contain "Enter a valid e-mail address"
          if (!errorMessageContainer.textContent.includes("Enter a valid e-mail address")) {
              ...
              // Trim the label text and remove the '*' character
               ...
               if (errorMessage && !errorMessageContainer.dataset.updated) {
